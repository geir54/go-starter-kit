...
**A fork of the original project with the goal of creating a more complete app. As of now react-bootstrap has been added and the todo example from [react.js](https://github.com/reactjs/redux/tree/master/examples/todos).**
